...
#include "../VaporChat/networking.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_myNetwork_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 69, 3) // "err"
    ...
    "myNetwork\0replyFinished\0\0QNetworkReply*\0"
    "reply\0error\0QList<QSslError>\0err"
};
...
void myNetwork::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->error((*reinterpret_cast< const QList<QSslError>(*)>(_a[1]))); break;
        default: ;
        }
